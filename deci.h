...
public:
    ...
    void free_memory();
    void init(int *ls_local_opt, int *ls_global_opt, lit *ls_unit_clause, int ls_unit_clause_count, const int *ls_clause_lit_count, int ls_solu_feasible, bool ls_solu_improved, int ls_h_inc);
...
void Decimation::init(int *ls_local_opt, int *ls_global_opt, lit *ls_unit_clause, int ls_unit_clause_count, const int *ls_clause_lit_count, int ls_solu_feasible, bool ls_solu_improved, int ls_h_inc)
{
    ...
    solu_improved = ls_solu_improved;
